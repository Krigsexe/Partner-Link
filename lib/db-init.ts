...
/**
 * Initialise automatiquement la base de données Supabase
...
export async function initDatabase() {
  ...
  try {
    ...
    if (error) {
      ...
      console.warn('exec_sql function not available, using direct execution')
      // On pourrait aussi exécuter via l'API REST de Supabase
    }
